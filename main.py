    ...
    try:
        if tip == 'odd':
            ...
            if str(result) in roulette_even:
                ...
                await resulttest(ctx)
                return
            elif str(result) not in roulette_even:
                eowin = 1
                error = 0
                print('Won Odd or Even')
                await resulttest(ctx)
...
@bot.command()
async def help(ctx):
    command = str(ctx.message.content.split('p'))
    if len(command) == 12:
        print(prefix + "help by " + str(ctx.author))
        await showhelp(ctx)
...
async def set(ctx):
    ...
    if requested_set == 'prefix':
        print(prefix + "set prefix by " + str(ctx.author))
        ...
        print(prefix + "set weeklytip by " + str(ctx.author))
        temp = str(ctx.message.content.split(' ')[2])
        if str(ctx.author.id) in mods:
        ...
        print(prefix + "set maximumbet by " + str(ctx.author))
        temp = str(ctx.message.content.split(' ')[2])
        if str(ctx.author.id) in mods:
        ...
        print(prefix + "set minimumbet by " + str(ctx.author))
        temp = str(ctx.message.content.split(' ')[2])
        if str(ctx.author.id) in mods:
...
async def clear(ctx):
    if str(ctx.channel.type) == 'private':
        ...
        try:
            ...
            print(prefix + "clear " + str(msg_to_delete) + " by " + str(ctx.author))
            if msg_to_delete == 1:
...
async def backup(ctx):
    print(prefix + "backup by " + str(ctx.author))
...
async def leaderboard(ctx):
    print(prefix + "leaderboard by " + str(ctx.author))
    for x in users:
...
async def permissions(ctx):
    print(prefix + "permissions by " + str(ctx.author))
    try:
...
async def stats(ctx):
    ...
    print(prefix + "stats by " + str(ctx.author))
    try:
...
async def mod(ctx):
    ...
    print(prefix + "mod by " + str(ctx.author))
...
async def give(ctx):
    ...
    print(prefix + "give by " + str(ctx.author))
...
async def weeklytip(ctx):
    print(prefix + "weeklytip by " + str(ctx.author))
...
async def register(ctx):
    ...
    print(prefix + "register by " + str(ctx.author))
...
async def tip(ctx):
    ...
    print(prefix + "tip by " + str(ctx.author))
